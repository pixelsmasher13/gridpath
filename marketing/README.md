...
- `blog/` — blog section: `index.html` is the post list, one HTML file per post
  (`cleanUrls` makes `blog/why-we-built-gridpath.html` serve at
  `/blog/why-we-built-gridpath`)
