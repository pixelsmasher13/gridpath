...
impl<'a> Model<'a> {
    ...
    pub(crate) fn reset_parsed_structures(&mut self) {
        ...
        // Formula indices are reassigned below; the lazily-built
        // unevaluable-formula flags are keyed by them.
    ...
    pub fn insert_sheet(
        ...
        // Structural change: import-time frozen coordinates are stale.
